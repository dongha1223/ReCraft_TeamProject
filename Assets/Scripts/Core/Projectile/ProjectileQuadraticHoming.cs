...
public class ProjectileQuadraticHoming : ProjectileBase
{
    ...
    public override void Setup(Transform target, HitInfo info, int maxCount = 1, int index = 0)
    {
        ...
        float angle = 45f + MathUtil.GetAngleFromPosition(start, end);
        point = MathUtil.GetNewPoint(start, angle, distance * 0.3f);
    }
    ...
    public override void Process()
    {
        ...
        transform.position = MathUtil.QuadraticCurve(start, point, end, Mathf.Clamp01(t));
    }
}
